...
export const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Therapy is not just about quick fixes. It focuses on helping you understand patterns in your thoughts, emotions, and actions so you can handle challenges even when they return. Just like if you stop going to gym you may end up losing muscles. Keeping notes and practicing the newly learnt skills will help you when you find yourself in similar situations later on in life. There’s no shortcut. Just like your body, your mind needs practice and repetition.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Everything you share in therapy is kept confidential and treated with respect. Your information is not shared with anyone without your permission, except in rare situations required by law, such as when there is a serious risk of harm to you or someone else.',
  },
  {
    question: 'Therapy has not worked for me in past? Why will it work now?',
    answer:
      'Sometimes therapy doesn’t work because the timing, the approach, or the therapist wasn’t the right fit. Therapy is not one-size-fits-all. We will work at your pace and focus on what feels most relevant to you now. Your past experience doesn’t mean therapy can’t help you in the present.',
  },
  {
    question: 'How do I know if I need therapy?',
    answer:
      'If something in your life feels overwhelming, confusing, or emotionally heavy, therapy can help. You don’t need to be in crisis to seek support. Therapy is also for people who want clarity, growth, and a better understanding of themselves.',
  },
  {
    question: 'What happens in the first session?',
    answer:
      'The first session is about getting to know you and understanding what brings you to therapy. You can share as much or as little as you feel comfortable with. We’ll talk about your concerns, your goals, and how therapy can support you.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'No preparation is required. You can simply come as you are. If you like, you can think about what you’d like help with, but it’s not necessary.',
  },
  {
